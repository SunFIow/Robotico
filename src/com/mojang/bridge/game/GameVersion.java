...
public interface GameVersion {
	 ...
	 *
	 * <p>
	 * The only guarantees about this string are that it will be 100 characters or less, and that it will always
	 * be unique to a version. Do not make any other assumptions on the format, as it may change at any time.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * This may not be unique to two versions, do not use it for anything programmatic - only for displaying to
	 * humans in lieu of any other data represented by this class.
	 * </p>
	 *
	 * <p>
	 * The format of this may change, it may be duplicated across multiple versions (such as in development, multiple
	 ...
	 *
	 * <p>
	 * A "release target" is the target version that this hopes to be. For example, multiple snapshots previewing
	 * features for "1.14" may return "1.14", as well as the actual "1.14" version itself.
	 * </p>
	 *
	 * <p>
	 * This value is suitable for grouping versions based on the same release type, and helping to disambiguate
	 * snapshots. The format contained within this string is still not guaranteed, and should not be used for anything
	 * other than checking for equality with another version's release target.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * This number is not unique, but is guaranteed to be comparable. Two versions with the same number are
	 ...
	 *
	 * <p>
	 * This is useful for having a rough idea of when a version was released. The actual release time of a version
	 * isn't well defined, as "release" has various different stages and meanings, so the build time is close enough.
	 * </p>
	 *
	 * <p>
	 * Note that you can't accurately sort versions by this field, as a patch for 1.13 may be released after 1.14
