...
import net.minecraft.nbt.TranslationTextComponent;
...
public class HoverEvent {
	...
	public <T> T getParameter(HoverEvent.Action<T> actionType) {
		return this.action == actionType ? actionType.castParameter(this.value) : null;
	}
	...
	public static class Action<T> {
		...
		public static final HoverEvent.Action<HoverEvent.ItemHover> SHOW_ITEM = new HoverEvent.Action<>(
				"show_item",
				true,
				(element) -> {
		...
		public static final HoverEvent.Action<HoverEvent.EntityHover> SHOW_ENTITY = new HoverEvent.Action<>(
				"show_entity",
				true,
				HoverEvent.EntityHover::deserialize,
				HoverEvent.EntityHover::serialize,
				HoverEvent.EntityHover::deserialize);
