...
public interface IReorderingProcessor {
	...
	@OnlyIn(Dist.CLIENT)
	static IReorderingProcessor func_242246_b(String p_242246_0_, Style p_242246_1_, Function<Integer, Integer> p_242246_2_) {
	...
	@OnlyIn(Dist.CLIENT)
	static ICharacterConsumer func_242237_a(ICharacterConsumer consumer, Function<Integer, Integer> p_242237_1_) {
