...
public class ListNBT extends CollectionNBT<INBT> {
	...
	private static final Set<Byte> typeSet = ImmutableSet.of((byte) 1, (byte) 2, (byte) 3, (byte) 4, (byte) 5, (byte) 6);
	...
	@Override
	public ListNBT copy() {
		Iterable<INBT> iterable = NBTTypes.getGetTypeByID(this.tagType).isPrimitive() ? this.tagList : Iterables.transform(this.tagList, INBT::copy);
